...
@RestController
@RequestMapping(value = "/mobile/tradem/warehouseDelivery/stock")
public  class MobileWarehouseDeliveryCtrl extends BaseCtrl<WarehouseDeliveryService, WarehouseDelivery> {
    ...
    private String billtypeCode = BaseConstant.BillTypeCode.XHCK;
